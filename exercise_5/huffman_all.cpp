...
#include <limits.h>
#include<time.h>
#define RRR "rar a -ep1 \"E:\\学习课件\\大四\\算法设计\\算法实验5_1\\5.rar\" \"E:\\学习课件\\大四\\算法设计\\算法实验5_1\\5.mp3\""
...
int main()
{
	...
	while(1)
	{
		...
		case 1: printf("Compressing……\n");
				...
				break;		
		case 2: printf("decompressing……\n");
				flag = extract(ifname, ofname);		// 解压，返回值用于判断是否文件名不存在
				break;		
		}
		finish= clock();
		printf("huffman needs %.3lfs\n",((finish-start)/CLOCKS_PER_SEC));
		if (flag == -1)
...
//		start= clock();
//		//system("7z a -ep1 \"E:\\学习课件\\大四\\算法设计\\算法实验5_1\\cacm1.7z\" \"E:\\学习课件\\大四\\算法设计\\算法实验5_1\\cacm1.all\""); //System：执行系统的命令行
//   		//system("rar a -ep1 \"E:\\学习课件\\大四\\算法设计\\算法实验5_1\\cacm1.rar\" \"E:\\学习课件\\大四\\算法设计\\算法实验5_1\\cacm1\""); //System：执行系统的命令行
//   		finish= clock();
//   		printf("7z needs 用了多少%.3lfs\n",((finish-start)/CLOCKS_PER_SEC));
   		
   		start= clock();
		//system("rar a -ep1 \"E:\\学习课件\\大四\\算法设计\\算法实验5_1\\cacm1.7z\" \"E:\\学习课件\\大四\\算法设计\\算法实验5_1\\cacm1\""); //System：执行系统的命令行
   		system(RRR); //System：执行系统的命令行
   		finish= clock();
   		printf("rar needs 用了多少%.3lfs\n",((finish-start)/CLOCKS_PER_SEC));
	}

	return 0;
}

//\"D:\\Program Files\\7-Zip\\7z.exe\" a -ep1 "C:\a.7z" "C:\test"
//"D:\Program Files\7-Zip\7z.exe" a -ep1 "C:\a.7z" "C:\test"
